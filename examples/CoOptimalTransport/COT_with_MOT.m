...
%
	...
	% Product manifold
	elements.gamma = MOT_multinomialdoublystochasticgeneralfactory(numS, numT, e1./numS, e2./numT);
	elements.W = MOT_multinomialdoublystochasticgeneralfactory(d1, d2, ones(d1,1)./d1, ones(d2,1)./d2);
